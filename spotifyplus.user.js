...
// @version      1.3.0
// @description  V0.8 mobile skin + V0.9 Library + V1.1 status nav, with persistent self-healing.
...
(() => {
'use strict';
const VERSION='1.3',ROOT='spotifyplus-mobile',STYLE='spotifyplus-style';
...
function heal(){
 ...
 ensureLibrary();dismissLibraryPrompt();wireLibraryNav();replaceGetAppWithStatus();
}
heal();
